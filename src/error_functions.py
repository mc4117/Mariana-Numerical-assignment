...
def error_fn(nx_range, nt_range, total_time, xmin = -math.pi, xmax = math.pi, H = 1, g = 1, c = 0.1):
 ...
 #   plt.loglog(dx_list, dx_list, 'k--', label = r'$O(\Delta x)$')
    plt.loglog(dx_list, dx_list**2, 'r--', label = r'$O(\Delta x^{2})$')
    plt.legend(loc = 2, fontsize = 'small')
    plt.xlim([min(dx_list), max(dx_list)])
    plt.xlabel(r"$\Delta x$")
    plt.ylabel("Error norm of u")
    plt.savefig("uerror_compared_dx_cossin_c=" + str(c) + ".png")
...
#    plt.loglog(dx_list, dx_list, 'k--', label = r'$O(\Delta x)$')
    ...
    plt.xlim([min(dx_list), max(dx_list)])
    plt.xlabel(r"$\Delta x$")
    plt.ylabel("Error norm of h")
    plt.savefig("herror_compared_dx_cossin_c=" + str(c) + ".png")
    ...
    plt.loglog(dt_list, dt_list, 'k--', label = r'$O(\Delta t)$')
    plt.loglog(dt_list, dt_list**2, 'r--', label = r'$O(\Delta t^{2})$')
    plt.legend(loc = 4, fontsize = 'small')
    plt.xlim([min(dt_list), max(dt_list)])
    plt.xlabel(r"$\Delta t$")
    plt.ylabel("Error norm of u")
    plt.savefig("uerror_compared_dt_cossin_c=" + str(c) + ".png")
    ...
    plt.xlabel(r"$\Delta t$")
    plt.ylabel("Error norm of h")
    plt.savefig("herror_compared_dt_cossin_c=" + str(c) + ".png")
